...
type Storage interface {
	...
	ListHostEndpoints(ctx context.Context) ([]*entity.HostEndpoint, *ierror.CoreError)
	...
	ListGNP(ctx context.Context, input model.ListGNPInput) ([]*entity.GlobalNetworkPolicy, *ierror.CoreError)
